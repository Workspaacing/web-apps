...
const config = {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      __APP_TITLE_TEXT__: JSON.stringify(process.env.APP_TITLE_TEXT ? process.env.APP_TITLE_TEXT : 'Workspaacing Office'),
      __COMPANY_NAME__: JSON.stringify(process.env.COMPANY_NAME ? process.env.COMPANY_NAME : 'Workspaacing Office'),
